...
class HomeworkItemAdapter(val homeworkItemList: MutableList<HomeworkItem>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeworkItemViewHolder {
       val binding = HomeworkItemLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false)
